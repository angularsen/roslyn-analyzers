...
namespace AssignAll.Test.Verifiers
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        /// <summary>
        ///     Given classes in the form of strings, their language, and an IDiagnosticAnalyzer to apply to it, return the diagnostics found in the string after
        ///     converting it to a document.
        /// </summary>
        ...
        protected static Diagnostic[] GetSortedDiagnosticsFromDocuments(DiagnosticAnalyzer analyzer, Document[] documents)
        {
            ...
            foreach (Document document in documents) projects.Add(document.Project);
        ...
        {
            if (language != LanguageNames.CSharp && language != LanguageNames.VisualBasic) throw new ArgumentException("Unsupported Language");

            Project project = CreateProject(sources, language);
            var documents = project.Documents.ToArray();

            if (sources.Length != documents.Length) throw new InvalidOperationException("Amount of sources did not match amount of Documents created");
